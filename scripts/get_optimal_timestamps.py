...
url_list = pd.read_csv(
    '/Users/charlesmiele/Dropbox/miele/measuring-founding-strategy-main/get_timestamps/startup_url_list.csv')
...
for index, row in url_list.iterrows():
    ...
    if file_id in timestamp_list:
        ...
        df = pd.read_csv(
            f"/Users/charlesmiele/Dropbox/miele/measuring-founding-strategy-main/get_timestamps/out/{file_id}")
        ...
        optimal_intervals.to_csv(
            f"/Users/charlesmiele/Dropbox/miele/measuring-founding-strategy-main/optimal_timestamps/{company_id}_timestamps.csv", index=False, header=["timestamp"])
...
log_report.to_csv(
    '/Users/charlesmiele/Dropbox/miele/measuring-founding-strategy-main/get_timestamps/optimal_timestamp_log_report.csv', index=False)
